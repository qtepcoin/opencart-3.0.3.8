...
class ModelCatalogReview extends Model {
	public function addReview($extension_id, $data) {
	...
	public function getReviewsByProductId($extension_id, $start = 0, $limit = 20) {
		if ($start < 0) {
			$start = 0;
		}
	...
	public function getTotalReviewsByProductId($extension_id) {
